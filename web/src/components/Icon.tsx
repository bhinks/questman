...
const ICON_PATHS: Record<string, string> = {
  ...
  chef:    'M6 3a3 3 0 0 1 6 0c0 1.1-.4 2.1-1 2.9V7h2c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2V9c0-1.1.9-2 2-2h2V5.9C8.4 5.1 8 4.1 8 3',
  tv:      'M7 2a2 2 0 0 0-2 2v5H3a1 1 0 0 0 0 2h18a1 1 0 1 0 0-2h-2V4a2 2 0 0 0-2-2H7zM7 4h10v5H7V4z',
