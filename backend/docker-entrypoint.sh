...
#   2. Run the seed. Idempotent for the demo path; provisions the hub
#      user iff HUB_USER_EMAIL + HUB_USER_PASSWORD are set. The `|| true`
#      means a seed failure doesn't keep the server from starting.
